...
public final class XMLUtil {
	...
	public static void main(String[] args)  {
		try {
			System.out.println("---------------------------------------------");
			String fileName = "D:/dongwuzhengquan/固收管理/dwzq_gdsy_备份/20200529_bak/月度跟踪评价/lc_GDSY_YDGZPJ_ZXXX.xml";
			Element rootElement = getRootElement(fileName);
			String createdateattributeStr = getAttribute(rootElement,"create-date");
			System.out.println("create-date:"+createdateattributeStr);
			Element  columnsCldElement = getChildElement(rootElement,"columns");
			Element[] columnCldElements  = getChildElements(columnsCldElement);
			for(Element ele:columnCldElements){
				Element bizTypeElement = getChildElement(ele,"biz-type");
				String bizTypeStr  = getElementValue(bizTypeElement);
				System.out.println("biz-type:"+bizTypeStr);
			}
			System.out.println("---------------------------------------------");
			String fileName2 = "D:/dongwuzhengquan/固收管理/dwzq_gdsy_备份/20200529_bak/月度跟踪评价/WF_YDGZPJ.xml";
			Element rootElement2 = getRootElement(fileName2);
			Element  columnsCldElement2 = getChildElement(rootElement2,"meta");
